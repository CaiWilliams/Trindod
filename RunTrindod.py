...
if __name__ == '__main__':
    #A = LCOERun('ResultSets/Presenation/Brazil/Brazil', 'Data/Initialpopulation.csv')
    #A.Run()
    #A.ReRun()
    #A.GA_Load_Population('Data/PanelData.csv', 'ResultSets/GA/Uk/GAMonthlyUk', 36, 5, 5, 0.15, 0, 5, [0,0,0,0.06,0.01], [25,1,1,0.245,392])
    Tests = ['ResultSets/Presenation/Japan/Japan', 'ResultSets/Presenation/SouthAfrica/SouthAfrica', 'ResultSets/Presenation/Spain/Spain', 'ResultSets/Presenation/UK/UK', 'ResultSets/Presenation/USA/USA']
    for Test in Tests:
        A = LCOERun(Test, 'Data/Initialpopulation.csv')
        A.GA_Load_Population('Data/PanelData.csv', Test, 36, 5, 2, 0.2, 0, 50, [0, 0, 0, 0.06, 0.01], [25, 1, 1, 0.245, 392])
